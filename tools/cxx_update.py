...
UPDATES = {
    ...
    '0x10002faa8': 'void ne::C_SPRITE_INSTANCING::Render()',
    '0x1000307f0': 'ne::C_TEXTURE * ne::C_SPRITE_INSTANCING::GetBoundTexture() const',
    '0x100030dc0': 'void ne::C_SPRITE_INSTANCING::RenderWorldSpace()',
    ...
    '0x1000307ac': 'void ne::C_SPRITE_INSTANCING::SetRefCountedMember(ne::C_TEXTURE * pTexture)',
    '0x100031828': 'void ne::C_SPRITE_INSTANCING::SetTexParam(int nIndex, int nValue)',
    '0x100066f6c': 'void ne::C_SPRITE_INSTANCING::SetSpritePosition(int nIndex, const S_VECTOR2 & position)',
    '0x100067020': 'void ne::C_SPRITE_INSTANCING::SetSpriteSize(int nIndex, const S_VECTOR2 & size)',
    '0x100066fc8': 'void ne::C_SPRITE_INSTANCING::SetSpriteAnchor(int nIndex, const S_VECTOR2 & anchor)',
    '0x100067078': 'void ne::C_SPRITE_INSTANCING::SetSpriteUvOrigin(int nIndex, const S_VECTOR2 & uvOrigin)',
    '0x1000670d0': 'void ne::C_SPRITE_INSTANCING::SetSpriteUvSize(int nIndex, const S_VECTOR2 & uvSize)',
    '0x100067128': 'void ne::C_SPRITE_INSTANCING::SetSpriteRotation(int nIndex, float flRotation)',
    '0x100067174': 'void ne::C_SPRITE_INSTANCING::SetSpriteScale(int nIndex, float flScaleX, float flScaleY)',
    '0x1000671cc': 'void ne::C_SPRITE_INSTANCING::SetSpriteColor(int nIndex, unsigned int nRed, unsigned int nGreen, unsigned int nBlue, unsigned int nAlpha)',
    ...
    '0x1001cc410': 'unsigned int GetLevelExpThreshold(int nLevel)',
    '0x1001cc438': 'const LevelUnlockEntry * GetLevelUnlockEntry(int nLevel)',
    '0x1001cc3b4': 'int ComputeLevelExpStep(int nLevel, int bAddHalf, float flBase, int bAddOffset)',
    '0x1001cc138': 'NSData * MakeLevelCustomizeHash(int nLevel, int nExp)',
    '0x1001cbf18': 'bool LoadPlayerLevelData(int * pOutLevelExp)',
    ...
    '0x10013183c': 'RbffNoteRecord * MusicSheet::GetNoteRecordByIndex(int nIndex)',
    '0x100131294': 'int MusicSheet::CalculateChartTiming()',
    '0x10012f604': 'SheetPathNode * MusicSheet::GetSheetPathNode(int nIndex)',
    '0x1001316b4': 'float MusicSheet::GetFirstPathSpeed()',
    '0x1001309a8': 'void MusicSheet::ResolveNoteScrollSpeeds()',
    '0x100130d64': 'bool MusicSheet::CheckNoteNearTime(int nTime, int nTarget)',
    ...
    '0x100030898': 'unsigned int C_SPRITE_INSTANCING::GetColorRed(int nIndex) const',
    '0x1000308e4': 'unsigned int C_SPRITE_INSTANCING::GetColorGreen(int nIndex) const',
    '0x100030930': 'unsigned int C_SPRITE_INSTANCING::GetColorBlue(int nIndex) const',
    '0x10003084c': 'unsigned int C_SPRITE_INSTANCING::GetColorAlpha(int nIndex) const',
    '0x1000307f8': 'void C_SPRITE_INSTANCING::SetTexParam(int nIndex, int nValue)',
    ...
    '0x10002f968': 'ne::C_SPRITE_INSTANCING::~C_SPRITE_INSTANCING()',
    ...
    '0x10002fa70': 'ne::C_SPRITE_INSTANCING::~C_SPRITE_INSTANCING()',
    ...
    '0x10005a0c4': 'void ne::C_SPRITE_INSTANCING::SetSpritePosition(int nIndex, const S_VECTOR2 & position)',
    '0x100059fbc': 'void ne::C_SPRITE_INSTANCING::SetSpriteSize(int nIndex, const S_VECTOR2 & size)',
    '0x100059f64': 'void ne::C_SPRITE_INSTANCING::SetSpriteAnchor(int nIndex, const S_VECTOR2 & anchor)',
    '0x10005a014': 'void ne::C_SPRITE_INSTANCING::SetSpriteUvOrigin(int nIndex, const S_VECTOR2 & uvOrigin)',
    '0x10005a06c': 'void ne::C_SPRITE_INSTANCING::SetSpriteUvSize(int nIndex, const S_VECTOR2 & uvSize)',
    '0x10005a174': 'void ne::C_SPRITE_INSTANCING::SetSpriteRotation(int nIndex, float flRotation)',
    '0x10005a11c': 'void ne::C_SPRITE_INSTANCING::SetSpriteScale(int nIndex, float flScaleX, float flScaleY)',
    '0x10005a1c0': 'void ne::C_SPRITE_INSTANCING::SetSpriteColor(int nIndex, unsigned int nRed, unsigned int nGreen, unsigned int nBlue, unsigned int nAlpha)',
    ...
    '0x100030804': 'ne::C_SPRITE_INSTANCING * ne::CreateSpriteInstancer(unsigned int nCapacity)',
