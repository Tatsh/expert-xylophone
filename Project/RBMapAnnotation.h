 ...
 * @c RBMapAnnotation, image base 0x100000000). Ghidra addresses are offsets relative to the
 * image base.
 */
...
/**
 * A searchable-spot map pin.
 */
@interface RBMapAnnotation : NSObject <MKAnnotation>

/**
 * Initialise a pin with its coordinate, title, subtitle, and model name.
...
/**
 * The spot's model name, used to look up the pin image.
