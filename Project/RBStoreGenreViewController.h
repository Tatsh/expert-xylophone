/**
 * @file
 * The genre-select list controller presented from the store page.
 *
...
/**
 * The genre-select list controller shown from the pack store page.
 */
@interface RBStoreGenreViewController :
    RBBaseViewController <UITableViewDelegate, UITableViewDataSource>

/**
 * The genre list table.
 */
@property(nonatomic, strong, nullable) UITableView *tableView;

/**
 * The pack-list model whose genres are listed. Held without ownership; the store page owns
 * it.
 */
@property(nonatomic, assign, nullable) RBStorePackList *packListCtrl;

/**
 * The store page that presented the controller, notified when a genre is selected. Held
...
/**
 * Build the genre table and size the preferred content to the genre count.
 * @ghidraAddress 0x1ca638
 */
- (void)loadView;

/**
 * Set the navigation title to the localised "Category" string as the view appears.
...
/**
 * Provide the cell for the genre at the given row.
...
/**
 * The number of sections in the genre table.
 * @param tableView The genre table.
...
/**
 * The number of genre rows in the section.
 * @param tableView The genre table.
...
/**
 * Genre-cell display hook. Intentionally does nothing.
 * @param tableView The genre table.
...
/**
 * Handle a genre row tap: notify the store page of the selected genre and dismiss.
 * @param tableView The genre table.
