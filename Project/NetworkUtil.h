/**
 * @file
 * URL builders for the game's secure API host (@c https://akx.s.konaminet.jp): assembles
...
/**
 * Builders for secure (HTTPS) API endpoint URLs on the game server.
 */
@interface NetworkUtil : NSObject

/**
 * Wrap an absolute server path in an @c https://akx.s.konaminet.jp URL.
...
/**
 * Build a secure API URL for a CGI endpoint under @c /akx/main/cgi/, optionally appending a
 * query string.
...
/**
 * The APNs device-token registration endpoint
...
/**
 * The device fingerprint parameter: the MD5 hex digest of the device UUID key with a fixed
...
/**
 * The device model name reported alongside play logs.
...
/**
 * The legacy play-log endpoint. Referenced by
...
/**
 * The version 2 play-log endpoint (@c .../akx/main/cgi/log/play/).
...
/**
 * The unlock-report endpoint (@c .../akx/main/cgi/unlocked/).
...
/**
 * The unlock-catalogue list endpoint.
...
/**
 * The music-unlock endpoint for a given music id, echoing @p randKey to guard against a
...
/**
 * The startup / web-info endpoint (@c .../akx/main/cgi/startup/), carrying the region code.
...
/**
 * The tutorial-status endpoint (@c .../akx/main/cgi/tutorial/).
...
/**
 * The downloadable-resource information endpoint (@c .../akx/main/cgi/v3/ssl_resource/).
...
/**
 * The searchable-spot campaign-master endpoint (@c .../akx/main/cgi/search_master/),
...
/**
 * The searchable-spot list endpoint (@c .../akx/main/cgi/gamecenter/).
...
/**
 * The terms-of-service list endpoint.
...
/**
 * The terms-of-service detail (single-term body) endpoint.
...
/**
 * The terms-of-service acceptance endpoint.
...
/**
 * Build the paged extend-note catalogue list endpoint URL, carrying the region code, the
...
/**
 * Build the extend-note-detail info endpoint URL for an item, carrying the device user-info
...
/**
 * Build the LINE-message share endpoint URL, carrying the region and device user-info.
...
/**
 * Build the store pack-list endpoint URL for a page of a genre.
...
/**
 * Build the store pack-info endpoint URL for a pack, carrying the device user-info only for
...
/**
 * Build the store music-info endpoint URL for a tune, carrying the device user-info.
...
/**
 * Build the V3 receipt-verification endpoint URL.
...
/**
 * Build the campaign-list endpoint URL.
...
/**
 * Build the campaign serial-code verification endpoint URL.
...
/**
 * Build the campaign item-info endpoint URL.
...
/**
 * Build the store manage-sort-list endpoint URL, carrying the region.
...
/**
 * Build the user-age registration endpoint URL.
