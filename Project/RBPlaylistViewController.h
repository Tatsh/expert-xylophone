/**
 * @file
 * The playlist screen's view controller.
 *
...
/**
 * Receives notifications when the playlist controller finishes a selection.
 */
@protocol RBPlaylistViewControllerDelegate <NSObject>

@optional
/**
 * Sent after a playlist filter row is selected.
...
/**
 * Sent after the music-or-artist sort segment changes.
...
/**
 * The playlist list screen, a grouped table of playlist filters, level nodes, or an
...
/**
 * The delegate notified when a selection or sort change completes. Held weakly.
 */
@property(nonatomic, weak, nullable) id<RBPlaylistViewControllerDelegate> delegate;
/**
 * The controller mode: @c 0 for the playlist menu or level node, @c 1 for the
 * add-to-playlist picker.
 */
@property(nonatomic, assign) NSInteger playlistType;
/**
 * The node mode: @c 0 for the top-level menu, @c 1 for the level-select node.
 */
@property(nonatomic, assign) NSInteger playlistNode;
/**
 * The music identifiers to add when a destination playlist is picked (add-to-playlist mode).
 */
@property(nonatomic, strong, nullable) NSMutableSet *musicSet;
/**
 * The menu row descriptors (each a dictionary of @c title and @c text) for section zero.
 */
@property(nonatomic, strong, nullable) NSArray *menuItems;
/**
 * The user's saved playlists, shown in section one.
 */
@property(nonatomic, strong, nullable) NSArray *playlistFiles;
/**
 * The row text colour for the "music" sort order.
 */
@property(nonatomic, strong, nullable) UIColor *musicColor;
/**
 * The row text colour for the "artist" sort order.
 */
@property(nonatomic, strong, nullable) UIColor *artistColor;
/**
 * The colour applied to the currently selected filter row.
 */
@property(nonatomic, strong, nullable) UIColor *selectedRowColor;
/**
 * The header title label's colour.
 */
@property(nonatomic, strong, nullable) UIColor *titleColor;
/**
 * The navigation-bar button tint colour (used on pre-iOS 7).
 */
@property(nonatomic, strong, nullable) UIColor *buttonColor;
/**
 * The navigation item's custom title label.
 */
@property(nonatomic, strong, nullable) UILabel *titleLabel;
/**
 * The music-or-artist sort toggle shown in the navigation bar.
 */
...
/**
 * The sort-segment change action: persist the sort order, notify the delegate, and retitle.
...
/**
 * Rebuild the menu rows (or the per-difficulty level counts) and reload the table.
