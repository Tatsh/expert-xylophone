/**
 * @file
 * A lightweight per-tune sort record for the store manage screens.
 *
...
/**
 * A per-tune sort record carrying the collation readings and source data for a single tune
 * on the store manage screens.
 */
@interface RBManageSortData : NSObject

/**
 * The artist-name yomigana reading, used as the collation string when sorting by artist.
 * @ghidraAddress 0x1cd5c4 (getter)
 * @ghidraAddress 0x1cd5d4 (setter)
 */
@property(nonatomic, strong, nullable) NSString *a_yomi;
/**
 * The tune-title yomigana reading, used as the collation string when sorting by title.
 * @ghidraAddress 0x1cd60c (getter)
 * @ghidraAddress 0x1cd61c (setter)
 */
@property(nonatomic, strong, nullable) NSString *m_yomi;
/**
 * The name of the pack the tune belongs to.
...
/**
 * The raw catalogue dictionary the tune's sort record was built from.
