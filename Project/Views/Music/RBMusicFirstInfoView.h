/**
 * @file
 * The one-shot "how to select a tune" hint overlay for the music-select screen.
 *
 * It is a
...
/**
 * The first-time information overlay shown over the music-select detail panel.
 *
...
/**
 * Creates the overlay and lays out its close button and hint imagery for the current device
 * idiom.
...
/**
 * Builds the overlay's subviews: a close button (positioned differently on iPad and iPhone),
...
/**
 * Fades the overlay fully in, guarding against a re-entrant animation.
 * @ghidraAddress 0xc9c10
 */
- (void)showAnimation;

/**
 * Fades the overlay out and removes it from its superview, guarding against a re-entrant
 * animation.
...
/**
 * The dismiss tap handler; hides the overlay.
