/**
 * @file
 * The play-history panel hosted by @c RBMusicView.
 *
...
/**
 * Initialises the panel, building its background artwork and graph, and starts hidden.
...
/**
 * Builds the background artwork view and the graph view, starts hidden and transparent, and
...
/**
 * Rebuilds the graph's plotted data from the play-history records for the current tune and
...
/**
 * Reveals the panel for a tune and difficulty and fades it in, then rebuilds the graph data.
...
/**
 * Fades the panel out and fully resets the graph once hidden.
