/**
 * @file
 * A store genre model describing one pack-list genre: its display name, identifier, and the
...
/**
 * A store model for a single pack-list genre.
 */
@interface StorePackListGenre : NSObject

/**
 * The accumulated pack identifiers for this genre.
 *
...
/**
 * Whether the server reported a further catalogue page for this genre.
 */
@property(nonatomic, readonly) BOOL packlistContinued;

/**
 * The number of packs already fetched for this genre, used as the next page offset.
 */
@property(nonatomic, readonly) NSUInteger numFetchedPack;

/**
 * Build a genre with the given display name and identifier.
...
/**
 * The number of packs accumulated for this genre.
...
/**
 * The boxed pack identifier at the given index, or @c nil when out of range.
...
/**
 * Append a fetched page of pack identifiers to the genre.
