...
/**
 * The Applilink recommend advert area web view.
 */
...
/**
 * The SDK delegate notified of the raw open, close, and failure notices.
 */
...
/**
 * The advert-type identifier being displayed.
 */
...
/**
 * The impression identifier assigned when the advert content finishes loading.
 */
...
/**
 * Configure the advert area with its advert model, location, type, request code, and
...
/**
 * Load the advert-area contents from a filesystem path.
...
/**
 * Tear down the advert area, notifying that the advert list disappeared.
...
/**
 * Notify the delegates that the advert list appeared and register the impression.
 * @ghidraAddress 0x23fa28
 */
- (void)appListDidAppear;

/**
 * Notify the delegates that the advert list disappeared and clear the delegates.
 * @ghidraAddress 0x23fb70
 */
- (void)appListDidDisappear;

/**
 * Notify the delegates of an advert-list load failure and clear the SDK delegate.
...
/**
 * Notify the delegates of an advert-list link failure.
...
/**
 * Handle an advert-tap request, routing App Store transitions, first-party clicks, and the
 * close command.
...
/**
 * Handle the App Store product page opening.
 * @ghidraAddress 0x241364
 */
- (void)openedNotice;

/**
 * Tear down the advert area and remove it from its superview.
 * @ghidraAddress 0x241368
 */
- (void)closeNotice;

/**
 * Handle an App Store product-page open error.
...
/**
 * Handle the App Store product page closing, tearing down the advert for advert model 5.
 * @ghidraAddress 0x2413ac
 */
- (void)appStoreCloseNotice;

/**
 * Handle the App Store product page having closed.
 * @ghidraAddress 0x2413d4
 */
- (void)appStoreClosedNotice;

/**
 * Handle an App Store product-page load failure.
 * @param error The load failure error.
...
/**
 * Handle the App Store product page transitioning.
