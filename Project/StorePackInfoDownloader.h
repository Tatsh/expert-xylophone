/**
 * @file
 * A downloader that fetches a single store pack's detailed music info.
 *
...
/**
 * Completion callbacks a @c StorePackInfoDownloader sends to its delegate.
 */
...
/**
 * Fetches a store pack's detailed music info.
 */
@interface StorePackInfoDownloader : NSObject <DownloaderDelegate>

/**
 * The pack whose detail is fetched and populated.
...
/**
 * Create a downloader for the given pack.
...
/**
 * The pack whose detail was fetched, once finished.
