/**
 * @file
 * The terms-of-service agreement popup.
 *
...
/**
 * Callbacks sent by @c RBTermAgreeView once the user has accepted the terms.
 *
...
/**
 * Sent after the terms acceptance has been submitted to the server and stored.
 *
...
/**
 * The terms-of-service agreement popup shown at first run or when the terms change.
 *
...
/**
 * Create the terms popup with the given frame and terms type.
 *
...
/**
 * Build the popup content: the gradation overlay, the title bar, the scrolling terms text
...
/**
 * Populate the terms text view with the fetched body and animate the popup content in.
 * @ghidraAddress 0x1c6c50
 */
- (void)showTermView;

/**
 * Fetch the terms body from the server and, on success, show it through @c showTermView.
 * @ghidraAddress 0x1c7958
 */
- (void)loadDetail;

/**
 * Agree-button handler: disable both buttons and submit the acceptance.
 * @ghidraAddress 0x1c7698
 */
- (void)selectAgree;

/**
 * Cancel-button handler: disable both buttons and dismiss the popup.
 * @ghidraAddress 0x1c7744
 */
- (void)selectDisAgree;

/**
 * POST the terms acceptance (user identity, region, terms type, and terms version) to the
...
/**
 * Show the optional grey overlay and start the loading indicator.
 * @ghidraAddress 0x1c77f0
 */
- (void)startLoadAnimation;

/**
 * Hide the optional grey overlay and stop the loading indicator.
...
/**
 * The terms type carried in the fetch and agree requests.
 */
@property(assign, nonatomic) int type;

/**
 * The view's own load-completion flag, distinct from the superclass @c animating flag.
 *
...
/**
 * Whether @c startLoadAnimation / @c endLoadAnimation also toggle the grey overlay.
...
/**
 * The rendered height of the terms text, used to gauge scroll progress.
 */
@property(assign, nonatomic) float termTextViewHeight;

/**
 * The fetched terms payload, keyed by @c "contents" and @c "terms_version".
 */
@property(strong, nonatomic, nullable) NSMutableDictionary *terms;

/**
 * The in-flight terms fetch or agree request.
 */
@property(strong, nonatomic, nullable) Downloader *downloader;

/**
 * The view controller that presents this popup.
 */
@property(weak, nonatomic, nullable) RBViewController *parentViewController;

/**
 * The delegate notified once the acceptance has been submitted.
 */
@property(weak, nonatomic, nullable) id<RBTermAgreeViewDelegate> delegate;

/**
 * The container view that hosts the scrolling terms text view.
 */
@property(assign, nonatomic, nullable) UIView *termView;

/**
 * The scrolling text view that shows the terms body.
 */
@property(assign, nonatomic, nullable) UITextView *termTextView;

/**
 * The grey overlay shown behind the loading indicator.
 */
@property(assign, nonatomic, nullable) UIView *grayView;

/**
 * The loading spinner shown while a request is in flight.
 */
@property(assign, nonatomic, nullable) UIActivityIndicatorView *indicatorView;

/**
 * The Agree button, enabled once the reader scrolls to the bottom.
 */
...
/**
 * The container view for the animated mascot and the scroll-progress artwork.
 */
@property(assign, nonatomic, nullable) UIView *pastelView;

/**
 * The animated mascot shown while scrolling.
 */
@property(assign, nonatomic, nullable) UIImageView *pastelImageView;

/**
 * The mascot shown once the reader has scrolled to the bottom.
 */
@property(assign, nonatomic, nullable) UIImageView *pastelImageFinishView;

/**
 * The scroll-progress track artwork.
 */
@property(assign, nonatomic, nullable) UIImageView *trackImageView;

/**
 * The scroll-progress fill artwork, clipped to the current scroll fraction.
 */
