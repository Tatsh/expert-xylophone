/**
 * @file
 * A downloader that fetches a store extend note's detailed info.
 *
...
/**
 * Completion callbacks a @c StoreExtendNoteInfoDownloader sends to its delegate.
 */
...
/**
 * Sent when an extend note's detailed info finished downloading.
...
/**
 * Sent as the extend note's detailed-info download makes incremental progress.
 * @param downloader The reporting downloader.
 */
- (void)storeExtendNoteInfoDownloaderProceed:(StoreExtendNoteInfoDownloader *)downloader;

/**
 * Sent when an extend note's detailed-info download failed.
 * @param downloader The reporting downloader.
 */
...
/**
 * Fetches a store extend note's detailed info.
 */
@interface StoreExtendNoteInfoDownloader : NSObject <DownloaderDelegate>

/**
 * The extend note whose detail is fetched and populated.
...
/**
 * The underlying HTTP download façade driving the in-flight request.
 * @ghidraAddress 0x17a3b0 (getter)
 * @ghidraAddress 0x17a3c0 (setter)
 */
@property(nonatomic, strong, nullable) Downloader *downloader;
/**
 * The error message from the most recent failed detail download, if any.
 * @ghidraAddress 0x17a3f8 (getter)
 * @ghidraAddress 0x17a408 (setter)
 */
@property(nonatomic, strong, nullable) NSString *errorMessage;
/**
 * The delegate notified of completion, progress, and failure.
...
/**
 * Create a downloader for the given extend note.
...
/**
 * The extend note whose detail was fetched, once finished.
