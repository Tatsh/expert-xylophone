/**
 * @file
 * The campaign and bonus-event data singleton.
 *
...
/**
 * Returns the shared campaign-data singleton, allocating it on first use.
...
/**
 * Parses a campaign descriptor dictionary, populating the campaign name, mode flags, store
...
/**
 * Parses a four-component colour array and stores it into the store skin colour matching the
 * given key.
...
/**
 * Starts, or reuses, an image download for a store image keyed by the given key.
...
/**
 * Seeds the singleton into the fixed March 2017 "hinabita" campaign name with the campaign
...
/**
 * Sets whether the active campaign is the March 2017 "hinabita" collaboration.
