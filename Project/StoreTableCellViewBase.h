/**
 * @file
 * The shared base view for a store table cell's product tile: a tappable background image
...
/**
 * Selection callbacks a store table cell view sends to its delegate.
 *
...
/**
 * The shared base view for a store table cell's product tile.
 */
@interface StoreTableCellViewBase : UIView

/**
 * The delegate notified of selections.
...
/**
 * The product-list index this view displays.
 * @ghidraAddress 0x177d58 (getter)
 * @ghidraAddress 0x177d68 (setter)
 */
@property(nonatomic, assign) NSUInteger index;
/**
 * The tappable background image view that hosts the tile content.
...
/**
 * Sets the view's background image on the background image view.
 * @param bgImage The background image.
 * @ghidraAddress 0x177ac0
 */
- (void)setBgImage:(nullable UIImage *)bgImage;
/**
 * Shows or hides the "new" corner badge, bringing it to the front when shown.
 * @param isNew Whether the item is flagged as new.
 * @ghidraAddress 0x177b4c
 */
- (void)setIsNew:(BOOL)isNew;
/**
 * Resets the tile content to its empty state.
 *
...
- (void)reset;
/**
 * Handles a tap on the tile and forwards it to the delegate.
