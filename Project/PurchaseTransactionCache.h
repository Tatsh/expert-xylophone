/**
 * @file
 * A lightweight per-transaction receipt cache.
 *
...
/**
 * A snapshot of a single StoreKit payment transaction used during receipt verification.
 */
...
/**
 * The App Store receipt data captured for verification.
...
/**
 * The StoreKit transaction identifier.
...
/**
 * The digest computed from the verification response.
...
/**
 * Build a cache from a StoreKit payment transaction.
 *
