...
/**
 * The number of records in the Classic result-window phone parts table (the static one).
 */
constexpr int kClassicPhonePartsRecordCount = 126;
/**
 * The upper bound the device-selecting accessor uses for both Classic parts tables.
 */
...
/**
 * The Classic pad parts table, which the device-selecting accessor uses on the pad.
 *
...
/** The number of records in each Classic phone-layout position table. */
constexpr int kClassicPositionRecordCount = 82;
/** The number of records in each Classic phone-layout separator table. */
constexpr int kClassicSeparatorRecordCount = 46;

/**
 * The Classic phone-layout position table for landscape orientation.
 *
...
/**
 * The Classic phone-layout position table for portrait orientation.
 *
 * Zero-initialised in the binary's @c __common segment and filled at runtime; the layer's
 * orientation flag selects between the landscape and portrait tables.
...
/**
 * The shared UV-palette table the Classic result window indexes by a parts record's
 * UV-palette index.
 *
...
/**
 * The glyph UV-palette table the Classic glyph dispatcher indexes by a glyph record's
 * UV-palette index.
 *
...
/**
 * One Classic phone-layout rectangle record: an anchored position, a carried secondary
...
/**
 * One anchored phone-layout rectangle, as returned by the position and centre accessors.
 *
...
/** The number of records in the Classic pad parts anchor table. */
constexpr int kClassicPartsAnchorRecordCount = 131;
/**
 * The Classic pad parts anchor table: one {x, y} anchor per parts slot.
 *
...
/** The number of vertex slots each Classic ribbon trail owns. */
constexpr int kTrailVertexStride = 20;
/** The total number of vertex slots in the Classic ribbon-trail storage. */
constexpr int kTrailVertexTotal = 79;
/**
 * The Classic ribbon-trail vertex storage.
 *
...
/**
 * The per-trail vertex counts the constructor reads alongside those starts.
 *
 * Every entry is 19.
...
/**
 * The Classic phone-layout separator table for portrait orientation.
 *
...
/**
 * The Classic phone-layout separator table for landscape orientation.
 *
 * Zero-initialised in the binary's @c __common segment and filled at runtime; the portrait flag
 * selects between the portrait and landscape tables.
...
/**
 * The Classic phone-layout position-by-state table, used on the iPad.
 *
...
/**
 * The Classic phone-layout position-by-state table for portrait orientation.
 *
...
/**
 * The Classic phone-layout position-by-state table for landscape orientation.
 *
 * Used instead of the state table off the iPad, selected by the orientation flag. Zero-initialised
 * in the binary's @c __common segment and filled at runtime; the record count is not
 * bounds-checked by the accessor.
...
/**
 * The single Classic phone-layout centre-position record for the state case (16-byte, no
 * anchor mode).
 *
 * Zero-initialised in the binary's @c __common segment and filled at runtime.
...
/**
 * The single Classic phone-layout centre-position record for portrait orientation (16-byte,
 * no anchor mode).
 *
...
/**
 * The single Classic phone-layout centre-position record for landscape orientation
