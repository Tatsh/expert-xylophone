...
// @ghidraAddress 0x310550, 0x310560, 0x310570, 0x310590, 0x3105a0
...
// @ghidraAddress 0x3df4b0, 0x3df4c8, 0x3df4e0
...
void EventEffectLayer::Update(float flDeltaTime) {
    ...
    // The binary seeds each icon curve's X values once, from the first frame's viewport width.
