/**
 * @file
 * The binary-resident part-layout tables for the parts-based title screen,
...
/**
 * One title-part layout record: the cached-texture index the part binds and its placement
...
struct TitlePartLayoutRecord {
    /**
     * The cached-texture index the part binds, doubling as its render-type selector
...
/**
 * The default-device part-layout table (0x53 records).
 * @ghidraAddress 0x309d48
 */
extern const TitlePartLayoutRecord g_aTitle2PartLayoutDefault[];

/**
 * The alt-frame (iPad) part-layout table (0x53 records).
 * @ghidraAddress 0x309580
 */
extern const TitlePartLayoutRecord g_aTitle2PartLayoutAltFrame[];

/**
 * The lettered/logo parts' UV atlas for the default device (45 records). A part indexes this
...
/**
 * The lettered/logo parts' UV atlas for the alt-frame (iPad) device (45 records). A part
