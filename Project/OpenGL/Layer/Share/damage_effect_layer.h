...
private:
    ...
    float m_aLaneValue[kLaneCount] = {};              // +0x2a4: seeded to one.
    float m_flEffectSize = {};                        // +0x2ac: seeded to one.
    int m_nStyle = {};                                // +0x2b0: 0, 1, or 2.
    // unsigned char m_aReserved2b4[4] = {};             // +0x2b4
};
