...
private:
    ...
    ne::C_TEXTURE *m_pFrameTexture = {};         // +0x08
    ne::C_TEXTURE *m_pOverlayTexture = {};       // +0x10: the shared gm_parts2 atlas.
    ne::C_DRAW_POLYGON_3D *m_pFrameMesh3d = {};  // +0x18: the border's 16-vertex mesh.
    ne::C_DRAW_POLYGON_3D *m_pMarkerMesh3d = {}; // +0x20: the marker's 8-vertex mesh.
    ne::C_DRAW_POLYGON_2D *m_pFrameMesh2d = {};  // +0x28: the frame's 24-vertex 2D mesh.
    // unsigned char m_aReserved30[8] = {}; // +0x30..+0x37
    ne::C_SPRITE_INSTANCING_2D *m_apInstancers[2] = {}; // +0x38, +0x40
    ...
    float m_flLayoutWidth = {};  // +0x70: the viewport size the layout was built for.
    float m_flLayoutHeight = {}; // +0x74
};
