/**
 * @file
 * The archived record of a single play: its tune, difficulty, seed, judgement tallies,
...
/**
 * An archivable record of one play, including the per-note events needed to replay it.
 */
...
/**
 * The tune identifier this replay belongs to.
...
/**
 * Whether a saved replay exists on disk for a tune and difficulty.
...
/**
 * Loads and unarchives the saved replay for a tune and difficulty.
...
/**
 * Archives a replay and writes it to disk as a Blowfish-enciphered ZIP.
...
/**
 * Enciphers archived replay data, prefixing it with a random salt word.
...
/**
 * Deciphers enciphered replay data and strips its salt-word prefix.
...
/**
 * Resets every stored field to @c nil.
