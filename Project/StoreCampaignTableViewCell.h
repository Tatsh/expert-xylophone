...
/**
 * Initialises the cell for the given device layout, reuse identifier, and row tag.
 *
...
- (nullable instancetype)initWithDeviceType:(BOOL)isPad
                            reuseIdentifier:(nullable NSString *)reuseIdentifier
                                        tag:(int)tag;
/**
 * Binds a campaign item and row index to the cell.
...
/**
 * Records whether the item is already downloaded and, if so, forces the purchased button
 * state.
...
/**
 * Whether the given tune item already exists in the local music library.
...
/**
 * The horizontal and vertical inset between the cell edge and the artwork.
 * @param isPad Whether the pad layout is active.
...
/**
 * The artwork frame size for the given device layout.
 * @param isPad Whether the pad layout is active.
...
/**
 * Sets the banner artwork image after its download finishes, then fades the artwork in.
