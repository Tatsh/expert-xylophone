/**
 * @file
 * Animated rainbow-and-particle background effect container view.
 *
...
/**
 * Animated rainbow-and-particle background container view.
 *
...
/**
 * The @c UIImageView layers whose opacity and position are keyframe animated.
 *
...
- (void)setupRainbow;
/**
 * Create and attach one @c RBMenuBGEffectPartView per @c EFFECT_NUM slot.
 * @ghidraAddress 0xe8ccc
 */
- (void)setupParticle;
/**
 * Build the background effect layers by chaining @c setupRainbow then @c setupParticle.
 * @ghidraAddress 0xe7288
 */
- (void)setupView;
/**
 * Attach a keyframe animation to one image layer.
...
/**
 * Start every particle layer and attach the rainbow and ring keyframe animations.
 * @ghidraAddress 0xe8404
 */
- (void)startAnimation;
/**
 * Stop every particle layer and remove all attached image-layer animations.
