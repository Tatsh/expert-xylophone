/**
 * @file
 * A single mixer-voice wrapper around a decoded @c SoundData asset.
 *
...
/**
 * A single mixer voice that streams a decoded @c SoundData asset into a buffer list.
 */
@interface SoundPlayer : NSObject

/**
 * The asset the voice is playing. The setter is ignored while the voice is playing.
...
/**
 * The playback cursor, in frames, into the current asset. The setter clamps the value to the
...
/**
 * Whether the voice loops its asset. The setter is ignored while the voice is playing.
...
/**
 * Start playing the current asset from the cursor.
...
- (BOOL)isPlaying;
/**
 * Mark playback as ended, releasing the voice back to the idle pool.
 * @ghidraAddress 0x355ec
 */
- (void)endPlay;
/**
 * Stop the voice, marking it as having reached the end of its asset.
 * @ghidraAddress 0x355fc
 */
- (void)stop;
/**
 * Whether the voice has reached the end of its asset.
 * @ghidraAddress 0x35610
 * @return @c YES once the asset is exhausted or the voice has been stopped.
 */
- (BOOL)isStop;
/**
 * Fill a buffer list with the next frames of the current asset, advancing the cursor and
