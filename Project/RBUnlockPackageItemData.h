/**
 * @file
 * A single item entry within an unlock package: its type, identifier, display name, asset
 * path, and point cost.
 *
...
/**
 * One unlock item entry: its metadata and point cost.
 */
...
/**
 * The item's point cost; packages sort their items by descending point value.
...
/**
 * Populate the item from an entry dictionary (@c ID, @c Name, @c Path, @c Point, and @c Type
 * entries).
