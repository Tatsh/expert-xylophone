...
/**
 * The Applilink SDK public facade.
 */
@interface ApplilinkNetwork : NSObject

/**
 * Initialise the SDK for an application, selecting a server environment.
 *
...
/**
 * Resume the SDK after the application returns to the foreground.
 *
...
/**
 * Set the Applilink user identifier.
...
/**
 * Whether the current operating-system version supports the SDK.
...
/**
 * The current device UDID cached by the SDK.
...
/**
 * Rotate any open advert screens to a new interface orientation.
 *
