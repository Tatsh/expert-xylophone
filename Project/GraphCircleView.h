/**
 * @file
 * A dashed-polyline plot view with filled circular per-point markers.
 *
...
/**
 * A dashed-polyline plot with filled circular per-point markers and min/max value labels.
 *
...
/**
 * The colour of the filled per-point circular markers.
 * @ghidraAddress 0x173a4 (getter)
 * @ghidraAddress 0x173b4 (setter)
 */
@property(nonatomic, strong, nullable) UIColor *dotColor;
/**
 * The stroke width used to draw each per-point circular marker.
...
/**
 * Sets the marker and line styling in one call, converting each colour through its
