/**
 * @file
 * A lightweight two-dimensional kinematic model for an animated menu character.
 *
 * It carries a
...
/**
 * The boundary-enforcement flags stored in @c useLimit.
 *
...
/**
 * A two-dimensional kinematic model with an optional bounded, bouncing playfield.
 */
...
/**
 * The per-frame horizontal velocity added to @c posX by @c update.
 * @ghidraAddress 0x19ea5c (getter)
 * @ghidraAddress 0x19ea6c (setter)
 */
@property(nonatomic, assign) float moveX;
/**
 * The per-frame vertical velocity added to @c posY by @c update.
 * @ghidraAddress 0x19ea7c (getter)
 * @ghidraAddress 0x19ea8c (setter)
 */
@property(nonatomic, assign) float moveY;
/**
 * The horizontal acceleration. It is reflected alongside @c moveX when the character
...
/**
 * The vertical acceleration. It is reflected alongside @c moveY when the character bounces
 * off a vertical edge.
...
/**
 * Initialises the receiver and zeroes every field through @c setDefault.
...
/**
 * Resets the position, velocity, acceleration, boundary box, and flags to zero.
 * @ghidraAddress 0x19e608
 */
- (void)setDefault;

/**
 * Advances the position by the velocity and, when limiting is enabled, clamps the position
...
/**
 * Reports whether all of the given boundary-enforcement bits are set in @c useLimit.
