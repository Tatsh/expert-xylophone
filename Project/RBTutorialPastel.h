/**
 * @file
 * The animated pastel speech-bubble view shown beside the tutorial spotlight.
 *
 * It is a @c UIView
...
/**
 * The tutorial pastel speech-bubble view.
 *
...
/**
 * Create the view, choosing the display rate from the current iPad idiom and sizing the
...
/**
 * Build the pastel bubble's four child image views from the tutorial message artwork.
 *
...
/**
 * Return the artwork clip rectangle for the child at @p index.
 *
...
/**
 * Return the layout point for the child at @p index.
 * @param index The child index (0 head, 1 body, 2 left tail, 3 right tail).
...
/**
 * Remove every running animation from the view's layer, its four child image views' layers,
 *        and their sublayers.
