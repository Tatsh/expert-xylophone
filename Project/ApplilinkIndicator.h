...
/**
 * The Applilink SDK's advert loading overlay.
 */
@interface ApplilinkIndicator : UIView

/**
 * The activity indicator spinner shown at the centre of the overlay.
 * @ghidraAddress 0x220290
 */
@property(strong, nonatomic, nullable) UIActivityIndicatorView *indicator;

/**
 * Initialise the overlay and its centred activity indicator for a frame.
 *
...
/**
 * Show the overlay and start the spinner animating.
 * @ghidraAddress 0x220124
 */
- (void)show;

/**
 * Hide the overlay, stop the spinner animating, and release it.
 * @ghidraAddress 0x22017c
 */
- (void)close;

/**
 * Make the overlay transparent and non-interactive after a touch event.
