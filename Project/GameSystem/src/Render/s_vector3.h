...
/**
 * A three-component float vector used by the engine's matrix and camera maths.
 *
...
struct S_VECTOR3 {
    ...
    /** The three components, readable under either of two interchangeable name sets. */
    union {
        /** The position or direction reading of the three components. */
        struct {
        ...
        /** The colour reading of the same three components. */
        struct {
