...
/**
 * Reports whether the device uses the iPad interface idiom.
 *
...
bool IsPad(void);
/**
 * One-time initialiser for the global device, locale, and filesystem environment values.
