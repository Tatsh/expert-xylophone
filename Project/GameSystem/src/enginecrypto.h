...
/**
 * Builds the MD5 digest of a C string and returns it as data.
...
/**
 * Computes the MD5 digest of a C string and returns it as a 32-character lowercase
 *        hexadecimal string.
 * @param pString The NUL-terminated string to digest.
...
/**
 * Computes the MD5 digest of a buffer into a 16-byte output.
...
/**
 * Computes the SHA-256 of a C string and returns it as a lowercase hexadecimal string.
