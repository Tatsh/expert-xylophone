...
private:
    caSource *m_pSource = {};   // +0x00: nullptr when the voice is free.
    bool m_bCallbackBound = {}; // +0x04
    // unsigned char m_aReserved05[7] = {}; // +0x05
    int m_nBytesRead = {};             // +0x0c
    int m_nReadPos = {};               // +0x10: offset into the source PCM block.
    unsigned short m_wGeneration = {}; // +0x14: packed into the play handle.
