...
/**
 * @brief One tracked touch inside the @c TouchManager slot array.
 *
...
struct TouchPoint {
    ...
    /** @brief The live x, the position UpdateTouchPoint and HandleTouchMoved match on. +0x0c */
    int nCurrentX = {};
    int nCurrentY = {};  /*!< The live y. +0x10 */
    int nPreviousX = {}; /*!< The previous x, saved before an update. +0x14 */
    int nPreviousY = {}; /*!< The previous y. +0x18 */
    /** @brief The frame-committed x; CompactTouchList copies the live x here. +0x1c */
    int nCommittedX = {};
    ...
    /** @brief Added this frame; cleared once CompactTouchList commits the slot. +0x2c */
    bool bIsNew = {};
