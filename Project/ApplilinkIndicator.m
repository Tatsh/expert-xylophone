...
//  against the arm64 disassembly: the soft-float indicator frame in -initWithFrame: (an 80x80
//  square at the origin) and half-opacity alpha, and the bounds-centre computation in
//  -layoutSubviews were recovered from the register moves the decompiler folds into
//  pseudo-variables. This is a plain Objective-C file because the class subclasses UIView and only
//  sends ordinary UIKit messages, with no C++.
//
