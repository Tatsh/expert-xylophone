/**
 * @file
 * An asynchronous image-fetch wrapper built on @c RBHttpUtil.
 *
...
/**
 * Delegate callbacks delivered on the main queue when the matching completion block is
 * unset.
 *
...
@optional
/**
 * Sent once the image has downloaded and decoded, when @c successBlock is unset.
...
/**
 * Sent when the download fails, when @c failureBlock is unset.
 *
...
/**
 * An asynchronous image downloader with block or delegate completion.
 */
@interface ImageDownloader : NSObject

/**
 * Whether to skip the @2x Retina variant and always fetch the plain image.
 * @ghidraAddress 0x854f0 (getter)
 * @ghidraAddress 0x85500 (setter)
 */
@property(nonatomic, assign) BOOL unUseRetina;
/**
 * The image URL to download, as a string.
 * @ghidraAddress 0x85510 (getter)
 * @ghidraAddress 0x85520 (setter)
 */
@property(nonatomic, strong, nullable) NSString *imageURL;
/**
 * The table-view index path passed back to the delegate with the finished image.
...
/**
 * The underlying HTTP connection this downloader drives.
...
/**
 * Invoked on successful completion; takes precedence over the delegate.
...
/**
 * Invoked on failure; takes precedence over the delegate.
...
/**
 * Initialise a downloader for the given image URL string.
...
/**
 * Start the download, delivering completion to the given blocks.
...
/**
 * Start the download, choosing the Retina or plain variant per @c unUseRetina and screen
 * scale.
...
/**
 * The decoded image, once the download has finished.
...
/**
 * Detach the delegate, drop the decoded image, and cancel any in-flight download.
