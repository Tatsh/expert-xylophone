 ...
 * @c \<action\>RbAction: selector and forwards the query to that handler; @c -webRbAction: builds
 * the news web-info URL from the query's @c id parameter and hands it to the application delegate.
 *
