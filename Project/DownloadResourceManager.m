...
//
//  The binary basename for this class is RBResourceDownloadViewController; this file keeps the
//  task's DownloadResourceManager name but the @interface, selectors, and ivars are the binary's.
//
