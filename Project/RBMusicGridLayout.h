...
/**
 * A paged grid layout that packs equal-sized cells into horizontally-scrolling pages.
 */
@interface RBMusicGridLayout : UICollectionViewLayout

/**
 * The minimum spacing between successive rows of cells.
...
/**
 * The minimum spacing between successive items within a row.
...
/**
 * The content inset applied within each page.
...
/**
 * The number of rows that fit on a single page, derived during @c -prepareLayout.
...
/**
 * The number of columns that fit on a single page, derived during @c -prepareLayout.
...
/**
 * The total number of pages, derived during @c -prepareLayout.
...
/**
 * The number of items that fit on a single page (@c rowCount times @c colCount).
...
/**
 * The scrolling direction of the layout.
...
/**
 * The size of a single page, taken from the collection view's bounds.
...
/**
 * The overall content size, spanning every page horizontally.
...
/**
 * Per-page rectangles. Declared by the class but not populated by the layout pass.
...
/**
 * The total number of items across every section, cached during @c -prepareLayout.
...
/**
 * The computed layout attributes, one per item, produced by @c -prepareLayout.
