 ...
 * @c RBErosionMarkUpdaterAlertController instead. The panel is hand-rolled, and every child frame
 * is scaled by the view's @c displayRate so the one layout serves both device idioms.
 */
 ...
 * label, a message label, and two buttons whose targets and actions are supplied by the delegate.
 *
