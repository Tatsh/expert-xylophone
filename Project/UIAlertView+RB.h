/**
 * @file
 * @c UIAlertView convenience factories used across the game.
 *
...
/**
 * Alert-presentation factories layered on @c UIAlertView.
 *
...
/**
 * Build a "DELETE SONG" confirmation alert (NO/YES) without showing it.
...
/**
 * Build a low-storage "Caution" alert (Close) without showing it.
 * @return The created alert, which the caller shows.
...
/**
 * Build and present the caution/low-free-space alert through @c UIAlertController.
 *
...
/**
 * Show a "restore purchased PACKs" prompt.
 * @param delegate The alert delegate.
...
/**
 * Show an "install restored PACKs" prompt.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "failed to connect Game Center" alert (OK).
 * @return The shown alert.
...
/**
 * Show the network-error alert with a tag of 0.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "failed to download" error alert (Close).
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "took over the data" notice (Close).
 * @return The shown alert.
...
/**
 * Show the "enable location service" information alert (OK).
 * @return The shown alert.
...
/**
 * Show an "open this place in the map?" confirmation with a caller-supplied title.
...
/**
 * Show an "Error" alert with a caller-supplied message (OK).
...
/**
 * Show an "Error" alert with a caller-supplied message and a Retry button.
 * @param message The alert message.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "failed to download" error alert with a Retry button.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show an "%\@ has been added." alert for an unlocked music item (OK).
 * @param delegate The alert delegate.
...
/**
 * Show the age/monthly-spending-limit selection alert (Cancel plus three choices).
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "monthly spending limit exceeded" alert (OK).
...
/**
 * Show a campaign's terms of use (OK).
...
/**
 * Show the "new version available" alert (Cancel plus an "AppStore" button).
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "insufficient points" alert (OK).
 * @return The shown alert.
...
/**
 * Show the "new version available, move to App Store?" alert with a tag of 3.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "update data found, download?" alert with a tag of 1.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "latest game data required" alert with a tag of 2 (OK).
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Show the "App Installed Reward" / "%d Lime Point" has been Added. alert (OK).
 *
...
/**
 * Show the "reordering needs a download" alert (NO/YES) built with a fixed message.
 * @param delegate The alert delegate.
 * @return The shown alert.
...
/**
 * Build the "WELCOME TO colette!!" theme-unlock alert (OK) without showing it.
 * @return The created alert, which the caller shows.
...
/**
 * Build the "enter serial code" alert (Cancel/OK) without showing it.
 * @param delegate The alert delegate.
 * @return The created alert, which the caller shows.
...
/**
 * Enable exclusive touch on every subview of a view.
...
/**
 * Build the "additional sequences" purchase-requirement alert (NO/YES) without showing it.
...
/**
 * Build the "purchase additional sequences?" alert (NO/YES) without showing it.
 * @param delegate The alert delegate.
 * @return The created alert, which the caller shows.
...
/**
 * Show an alert listing the given strings, one per line under a fixed header (YES).
...
/**
 * Show the "Erosion Mark play history found, fix score?" alert (NO/YES).
 * @param delegate The alert delegate.
 * @return The shown alert.
