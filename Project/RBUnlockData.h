/**
 * @file
 * A singleton data model describing the unlock catalogue: the catalogue version string and
...
/**
 * Returns the shared unlock-data singleton, allocating and initialising it on first use.
...
/**
 * Persists the receiver. The shipped build performs no work here.
 * @ghidraAddress 0x19abd4
 */
- (void)save;

/**
 * Parses the unlock catalogue from a server-supplied dictionary into the theme matching the
...
/**
 * Returns the package list for the player's currently selected theme.
...
/**
 * Seeds the Colette-theme catalogue with its built-in tutorial packages.
