/**
 * @file
 * Builds the play-result share image posted to Twitter.
 *
...
/**
 * Builds the play-result share image for Twitter.
 */
...
/**
 * The tune title image drawn at the top of the result.
 */
@property(nonatomic, strong, nullable) UIImage *titleImage;

/**
 * The artist image drawn below the title.
 */
@property(nonatomic, strong, nullable) UIImage *artistImage;

/**
 * The difficulty grade: 0 basic, 1 medium, 2 hard, 3 special.
 */
@property(nonatomic, assign) int grade;

/**
 * The tune level within its grade, zero-based.
 */
@property(nonatomic, assign) int level;

/**
 * The game mode: 1 selects the rival-battle two-column layout, otherwise a single column.
 */
@property(nonatomic, assign) int gameType;

/**
 * The tune's total note count, compared against a column's maximum combo to mark a full
 * combo.
 */
@property(nonatomic, assign) int noteNum;

/**
 * The player side that owns the primary column: 0 draws the "you" badge, 1 the "rival"
 * badge.
 */
@property(nonatomic, assign) int color;

/**
 * Sets the score of one column.
...
/**
 * Sets the achievement rate of one column.
...
/**
 * Sets the JUST count of one column.
...
/**
 * Sets the GREAT count of one column.
...
/**
 * Sets the GOOD count of one column.
...
/**
 * Sets the MISS count of one column.
...
/**
 * Sets the JUST REFLEC count of one column.
...
/**
 * Sets the maximum combo of one column.
...
/**
 * Sets the tune name of one column.
...
/**
 * Composites the whole result and returns the finished share image.
