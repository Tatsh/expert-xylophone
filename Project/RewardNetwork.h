/**
 * @file
 * The Applilink reward-network advert facade.
 *
...
/**
 * Open the reward-advert screen at the given ad location without a parent view, reporting to
 * @p delegate.
...
/**
 * Open the reward-advert screen inside @p parentView at the given ad location, reporting to
 * @p delegate.
...
/**
 * Open the reward-advert screen inside @p parentView at the given ad location with a request
...
/**
 * Query the all-install flag asynchronously, invoking @p callback with the flag and an error
...
/**
 * Query the ad-display status asynchronously, invoking @p callback with a status dictionary
...
/**
 * Query the reward-advert status asynchronously, invoking @p block with the status code and
...
/**
 * Hide or show the reward-advert navigation bar by forwarding to the reward core.
