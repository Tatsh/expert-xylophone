/**
 * @file
 * The in-game settings menu overlay.
 *
...
/**
 * The settings menu overlay presented over the music-select screen.
 *
...
/**
 * Create the settings overlay and build its panel and buttons.
 *
...
/**
 * Build the panel and its column of menu buttons.
 *
...
/**
 * Play the themed open sound effect and show the panel.
 * @ghidraAddress 0xeb0e4
 */
- (void)OpenView;

/**
 * Play the themed cancel sound effect and hide the panel.
 *
...
/**
 * Animate the panel open: fade the overlay in and grow the panel downward from the top edge.
 * @ghidraAddress 0xeb194
 */
- (void)showAnimation;

/**
 * Animate the panel closed: disable the buttons and shrink the panel back up to the top
 * edge.
...
/**
 * Close-animation completion: notify the parent, remove the overlay, and clear the parent's
...
/**
 * Dismiss the panel when a touch ends outside it.
...
/**
 * Handle the customise button: open the customise sub-screen and clear the new-item flag.
 * @ghidraAddress 0xebbc0
 */
- (void)SelectCustomizeButton;

/**
 * Handle the theme button: open the theme sub-screen and clear the new-theme flag.
...
/**
 * Handle the how-to-play button: open the how-to-play sub-screen and mark it as seen.
 * @ghidraAddress 0xebdf0
 */
- (void)SelectHowToPlayButton;

/**
 * Handle the information button: open the notification-page sub-screen.
 * @ghidraAddress 0xebf1c
 */
- (void)SelectInfoButton;

/**
 * Handle the terms button: open the terms-of-use sub-screen.
 * @ghidraAddress 0xebf94
 */
- (void)SelectTermButton;

/**
 * Handle the Applilink button: open the Applilink sub-screen and clear the unread count.
 * @ghidraAddress 0xec00c
 */
- (void)SelectApplilinkButton;

/**
 * Handle the exit button: close the panel.
 * @ghidraAddress 0xec0c0
 */
- (void)SelectExitButton;

/**
 * Handle the map-search button: open the map-search sub-screen.
...
/**
 * The customise menu button, exposed for the music-select view's flash-effect handling.
